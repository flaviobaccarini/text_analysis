...
## Tutorials
In the [notebooks](https://github.com/flaviobaccarini/text_analysis/tree/main/notebooks) the user can find three files.
There is a detailed explanation of the scripts for the train and test of a logistic regressor on spam dataset (see [explanation logistic regressor](https://github.com/flaviobaccarini/text_analysis/blob/main/notebooks/Explanation%20Logistic%20Regressor%20spam%20dataset.ipynb)).
Then the user can find a detailed explanation of the scripts for the train and test of a Bidirectional LSTM on covid dataset  (see [explanation bidirectional LSTM](https://github.com/flaviobaccarini/text_analysis/blob/main/notebooks/Explanation%20Bidirectional%20LSTM%20COVID%20dataset.ipynb)).
The last file [tutorial logistic regressor](https://github.com/flaviobaccarini/text_analysis/blob/main/notebooks/Tutorial%20script%20logistic%20regressor.ipynb) is a tutorial about how to use the scripts for an analysis with a logistic regressor model.
