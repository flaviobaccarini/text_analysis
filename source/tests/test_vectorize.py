...
def test_voc_rand_text(list_words):
    ...
    # number of sub-lists inside sentences is equal to the number of sentences
...
def test_flatten_vocabulary():
    ...
    of strings containing all the tokenized sentences.
...
def test_encode_labels():
    ...
    # verify that indices of the categorical labels (0, 1) are equal
...
def test_encode_random_labels(unique_labels):
    ...
    # (y_categorical contains all the labels)
    for y_cat in np.unique(y_categorical):
        y_indices[y_cat] = np.where(y_categorical == y_cat) 

    # verify that indices of the categorical labels are equal
...
def test_value_mean_emb_vect():
    ...
    with at least two occurencies within the vocabulary will be part of the Word2Vec
    dictionary. 
    '''
...
def test_vector_layer():
    ...
    # we calculate maxlen to pad/truncate sequences
    ...
    # sizes of the two vocabularies match 
...
def test_shape_vectorize_X_tf(maxlen, text_to_vectorize):
    ...
    # find unique and flatten vocabulary
    uniq_voc = flatten_unique_voc(vocabulary)
...
def test_value_vectorize_X_tf():
    ...
    In this test function the correct output values of the vector text
    ...
    # we expect 'hello' in vector ('hello' == vector[0][0])
    ...
    # where the zeros are given by the padding operation (in this example there are
